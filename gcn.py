...
def main():
    ...
    sched = optim.lr_scheduler.StepLR(optimizer, step_size=50, gamma=0.2)
    ...
    for epoch in range(num_epoch):
        ...
        for i, (inputs, labels) in enumerate(dataloader_train):
            #labels.squeeze(1)
            #labels=transformLabels(labels).cuda()
